...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Cambiado!</strong> Los datos han sido actualizados.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            <?php 
                }
            ...
            <strong>Eliminado!</strong> Los datos han sido borrados.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            <?php 
                }
                ...
                <div class="p-4">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td scope="row"><?php echo $dato->Id_empleados; ?></td>
                                ...
                                <td><a class="text-success" href="editar.php?Id_empleados=<?php echo $dato->Id_empleados; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                <td><a onclick="return confirm('Deseas eliminar?');" class="text-danger" href="eliminar.php?Id_empleados=<?php echo $dato->Id_empleados; ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
